      ...
      <div className="a-right">
        <div className="a-wrapper">
          ...
          <p className="a-desc">
            ...
            always been a huge technology computer nerd. I have always excelled
            in my professions, and have always strived to be better and better.
            I have moved up in every aspect of the hospitality industry that has
            been available to me. I have been in a General Management position
            for 12 years, but now I am ready to switch career paths and do
            something that I know that I was destined to do, Software
            Development!
          </p>
          <p className="a-desc">
            ...
            approach coding. If I don't understand something, I can always learn
            it. I can dig deep, read up on concepts and conventions, look at
            examples of working code and analyze how it is constructed.
          </p>
          <p className="a-desc">
            ...
            ability to multitask, yet really focus on a dedicated task in order
            to meet a deadline. I ask concise questions when necessary, work
            well with others, and have the experience leading others.
          </p>
        </div>
      </div>
    </div>
